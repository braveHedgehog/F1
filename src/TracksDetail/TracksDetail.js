  ...
  return (
    <ScrollView style={Style.page} >
      ...
      <View style={Style.container} >
        ...
        <Text style={Style.content}>{first_grand_prix}</Text>
        </View>
        <View style={Style.align} >
        <Text style={Style.title}>Number of Lap</Text>
        <Text style={Style.content}>{number_of_laps}</Text>
        </View>
        <View style={Style.align} >
        <Text style={Style.title}>Circuit Length</Text>
        <Text style={Style.content}>{circuit_length}</Text>
        </View>
        <View style={Style.align} >
        <Text style={Style.title}>Race Distance</Text>
        <Text style={Style.content}>{race_distance}</Text>
        </View>
        <View style={Style.align} >
        <Text style={Style.title}>Lap Record</Text>
        <Text style={Style.content}>{lap_record}</Text>
        <Text style={Style.driver}>{lap_record_driver}</Text>
        </View>
        <Text style={Style.track_name} >{track_name}</Text>
